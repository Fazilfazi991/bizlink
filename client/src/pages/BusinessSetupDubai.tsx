          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {setupOptions.map((option, i) => (
              <ScrollReveal key={i} delay={i * 0.1}>
                <div className="flex flex-col h-full p-12 bg-slate-50 rounded-[3.5rem] border border-slate-100 hover:shadow-2xl transition-all hover:-translate-y-1 group relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ScrollReveal delay={0.1}>
              <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl transition-all h-full">
