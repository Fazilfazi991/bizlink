      ...
      <section className="py-24 relative border-b border-slate-200 bg-[#f8fafc] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Mainland */}
            <div className="flex flex-col bg-[#0b1b28] rounded-[2rem] overflow-hidden text-white shadow-xl hover:-translate-y-2 transition-transform duration-300">
            ...
            {/* Freezone */}
            <div className="flex flex-col bg-[#0d102e] rounded-[2rem] overflow-hidden text-white shadow-xl hover:-translate-y-2 transition-transform duration-300">
              <div className="h-64 overflow-hidden relative">
            ...
            {/* Offshore */}
            <div className="flex flex-col bg-[#305c4f] rounded-[2rem] overflow-hidden text-white shadow-xl hover:-translate-y-2 transition-transform duration-300">
              <div className="h-64 overflow-hidden relative">
